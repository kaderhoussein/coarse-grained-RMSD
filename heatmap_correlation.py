...
file_path = "/home/zozo/Bureau/Coarse_grain_RMSD/coarse-grained-RMSD/data/SCORES_test/pearson_results.csv"  # Remplacez par le chemin vers votre fichier
...
correlation_matrix = correlation_data.set_index("RNA")
